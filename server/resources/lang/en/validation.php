...
return [
   ...
   /* 'accepted'             => 'The :attribute must be accepted.',
    ...
    //fin inglés
    //en español
    'accepted'             => 'El :attribute puede ser acceptado.',
    'active_url'           => ':attribute No es una URL '.utf8_encode('válida').'.',
    ...
    'alpha_num'            => ':attribute solo puede contener letras, números.',
    ...
    'gte'                  => [
        ...
        'string'  => ':attribute debe ser mayor o igual :value caracteres.',
    ...
    'ipv4'                 => 'debe ser una dirección IP válida.',
    'ipv6'                 => 'debe ser una dirección IP válida.',
    ...
    'required_if'          => 'campo requerido cuando :other es :value.',
    'required_unless'      => 'campo requerido a  no ser que :other sea :values.',
    'required_with'        => 'campo requerido cuando :values esté presente.',
    'required_with_all'    => 'campo requerido cuando :values esté presente.',
    'required_without'     => 'campo requerido cuando :values no esté presente.',
    'required_without_all' => 'campo requerido cuando ninguno de :values esté presente.',
    'same'                 => 'debe coincidir con :other .',
    'size'                 => [
        'numeric' => 'debe ser :size.',
        'file'    => 'debe ser :size kilobytes.',
        'string'  => 'debe ser :size caracteres.',
        'array'   => 'debe contener :size items.',
    ],
    'string'               => 'debe ser una cadena de carácteres.',
